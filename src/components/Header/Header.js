  ...
  return (
    <div className="w-full sticky top-0 z-50">
      <div className="w-full bg-amazon_dark text-white px-4 py-3 flex gap-4 items-center">
        ...
        {/* ****************************Image End here********************************* */}
        {/* ****************************Deliver Start here********************************* */}
        <div className=" items-center hidden mdl:inline-flex headerHover">
          <LocationOnIcon />
          <div className="ml-1">
        ...
        <div className="h-10 rounded-md hidden lgl:flex flex-grow relative">
          ...
          <input value={searchProduct} onChange={(e)=>setSearchProduct(e.target.value)}
            ...
            type="text"
          />
          <span onClick={handleSearchClick} className="w-12 h-full flex bg-amazon_yellow items-center justify-center text-amazon_blue cursor-pointer rounded-tr-md rounded-br-md hover:bg-[#f3a847] duration-300">
            <SearchIcon />
          </span>
          {showDropdown && (
            <div>
              <ul className="absolute w-50 h-60 top-10 left-0 overflow-y-scroll overflow-x-hidden bg-white border-[1px] text-black p-2 flex-col gap-1 z-50">
                {allItems.map((item) => {
                  return (
                    <li
        ...
        {/* ****************************Signin End here********************************* */}
        {/* ****************************Orders Start here********************************* */}
        <div className="flex flex-col items-start justify-center mdl:inline-flex headerHover">
